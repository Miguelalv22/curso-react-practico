...
function MyAccount() {
  ...
  const renderEditUserInfo = () => {
    return (
      <form ref={form} className="flex flex-col gap-4 w80">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            placeholder="Peter"
            className="rounded-lg border border-black placeholder:font-light placeholder:text-sm placeholde:text-black/60 focus:outline-none py-2 px-4"
          />
        </div>
        <div className="flex flex-col gap-1">
